...
const Login = () => {
  const gitHuburl = `https://github.com/login/oauth/authorize?client_id=8f053229e25de08ed09d&scope=user:email&redirect_uri=http://3.37.234.113/login/github`;
  ...
  const kakaoUrl = `https://kauth.kakao.com/oauth/authorize?client_id=9e5543492002f4b2a2853b92861bb134&redirect_uri=http://3.37.234.113/login/kakao&response_type=code`;
  const naverUrl = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=DhAPofnVzIKvhXOtMvY_&state=200&redirect_uri=http://3.37.234.113/login/naver`;
